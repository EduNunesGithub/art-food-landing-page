...
export const AppComingSoon = () => {
  ...
  return (
    <motion.article
      className="flex flex-row items-end relative text-black w-full z-0"
      initial="hidden"
      variants={{
        hidden: {},
        visible: {
    ...
    >
      <div className="flex flex-col gap-4 max-w-128 w-full z-0">
        <motion.h2
          ...
          variants={{
            hidden: { filter: "blur(0.25rem)", opacity: 0, x: "1.5rem" },
            visible: { filter: "blur(0rem)", opacity: 1, x: "0rem" },
          }}
        >
        ...
        >
          Receitas organizadas, livros de receitas, menus personalizados e
          grupos de planejamento — tudo conectado ao seu assistente inteligente.
        </motion.p>
      ...
      <motion.div
        ...
        transition={{ duration: 1, ease: "anticipate" }}
        variants={{
          hidden: { filter: "blur(0.5rem)", y: "100%" },
          visible: { filter: "blur(0rem)", y: "0%" },
        }}
      >
        <Mockup>
          <Image
